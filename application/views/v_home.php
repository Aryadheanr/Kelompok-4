...
<head>
    ...
    <link rel="shorcut icon" type="text/css" href="<?php echo base_url() . 'assets/images/api.jpg' ?>">
            ...
            <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item active">
                        <div class="carousel-background"><img src="<?php echo base_url() . 'theme/images/kkn4.jpg' ?>"
                                alt=""></div>
                        <div class="carousel-container">
                            <div class="carousel-content">
                                <h2>NEWS!!</h2>
                                <h3>
                                    <p>KKN di Desa Penari Tembus 6 Juta Penonton !</p>
                                </h3>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-background"><img src="<?php echo base_url() . 'theme/images/aaaaaa.jpg' ?>"
                                alt=""></div>
                        <div class="carousel-container">
                            <div class="carousel-content">
                                <h2>HOT</h2>
                                <h3>
                                    <p>Rahasia Hidup Hemat & Aman Finansial di Tengah Dunia Digital yang Bikin FOMO </p>
                                </h3>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-background"><img src="<?php echo base_url() . 'theme/images/l6.jpg' ?>"
                                alt=""></div>
                        <div class="carousel-container">
                            <div class="carousel-content">
                                <h2>Infografis</h2>
                                <h3>
                                    <p>Infografis Angin Segar Boleh Lepas Masker, Kode Keras Pandemi ke Endemi Covid-19 </p>
                                </h3>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-background"><img src="<?php echo base_url() . 'theme/images/bola.jpg' ?>"
                                alt=""></div>
                        <div class="carousel-container">
                            <div class="carousel-content">
                                <h2>Bola</h2>
                                <h3>
                                    <p>Bola Ganjil: Dipermalukannya Para Raksasa di Piala FA </p>
                                </h3>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-background"><img src="<?php echo base_url() . 'theme/images/saham.jpg' ?>"
                                alt=""></div>
                        <div class="carousel-container">
                            <div class="carousel-content">
                                <h2>Saham</h2>
                                <h3>
                                    <p>Mau beli saham tapi bingung caranya? Cek acuannya! </p>
                                </h3>
        ...
        <section id="contact" class="section-bg wow fadeInUp">
            <div class="container">
                ...
                <div class="section-header">
                    <h3>Contact Us</h3>
                    <p>Kirim Pesan Dibawah Untuk Menghubungi Admin</p>
                </div>
                ...
                <div class="row contact-info">
                    ...
                    <div class="col-md-4">
                        <div class="contact-address">
                            ...
                            <h3>Address</h3>
                            <address>Cengkareng dan Sekitarnya</address>
                        </div>
                    </div>
