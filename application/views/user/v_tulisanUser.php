        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'user/tulisan/add_tulisan'?>"><span class="fa fa-plus"></span> Add New</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tr>
                  ...
                  <td style="text-align:center;"> 
                                                    <?php
                                                        if ($status == '1') {
                                                        ?>
                                                          <center><span class='label label-info'> Publish</span></center>
                                                        ...
                                                        ?>
                                                    <center> <span class='label label-danger'>Belum Publish</span></center>
                                                    <?php
                                                        }
                  ...
                  <td style="text-align:right;">
                        <a class="btn" href="<?php echo base_url().'user/tulisan/get_edit/'.$tulisan_id;?>"><span class="fa fa-pencil"></span></a>
...
<!-- ./wrapper -->
	...
	<?php foreach ($data->result_array() as $i) :
            ...
            ?>
	<!--Modal Hapus Pengguna-->
        <div class="modal fade" id="Modalstatus<?php echo $tulisan_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Update Status Berita</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'user/tulisan/update_status'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
							       <input type="hidden" name="kode" value="<?php echo $tulisan_id;?>"/> 
