              ...
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                  ...
                  <td><?php echo $tulisan_judul;?></td>
        				  ...
        				  <td><a  class="btn btn-info btn-flat" data-toggle="modal" data-target="#Modalstatus<?php echo $tulisan_id;?>"><span class="fa fa-eye"> Update Status</span></a></td>
        ...
        <div class="modal fade" id="Modalstatus<?php echo $tulisan_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/tulisan/update_status'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
							       <input type="hidden" name="kode" value="<?php echo $tulisan_id;?>"/> 
